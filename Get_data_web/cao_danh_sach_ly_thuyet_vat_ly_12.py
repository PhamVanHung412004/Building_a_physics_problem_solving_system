...
list_url = [
    "https://www.vietjack.com/vat-li-12-kn/ly-thuyet-vat-li-lop-12.jsp",
    "https://www.vietjack.com/vat-li-12-ct/ly-thuyet-vat-li-lop-12.jsp",
    "https://www.vietjack.com/vat-li-12-cd/ly-thuyet-vat-li-lop-12.jsp"
]
...
with open("danh_sach_ly_thuyet_vat_li_12.json", "w", encoding="utf-8") as f:
    json.dump(data, f, ensure_ascii=False, indent=2)

# ---------------------------------------------------------------------------------------------------------------------
json_path = "danh_sach_ly_thuyet_vat_li_12.json"
...
for i, lesson in enumerate(lessons, start=1):
    ...
    invalid_keywords_in_key = ["Lý thuyết Vật Lí 12 Bài"]
...
with open("ly_thuyet_12.json", "w", encoding="utf-8") as f:
