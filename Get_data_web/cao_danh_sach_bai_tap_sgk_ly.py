...
list_url = ['https://www.vietjack.com/vat-li-12-kn/index.jsp',  # doi link
            'https://www.vietjack.com/vat-li-12-ct/index.jsp',
            'https://www.vietjack.com/vat-li-12-cd/index.jsp']
...
for url in list_url:
    ...
    for link in data:
        ...
        for a in links:
            ...
            if href and "Vật Lí 12:" in text:  # sua lop
                match = re.search(r'/vat-li-12-[^/]+/',href)  # sua lop
                if match:
                    ds_cau_hoi.append({
                        "text": text,
                        "link": href
...
with open("danh_sach_cau_hoi_vat_li_12.json", "w", encoding="utf-8") as f:  # sua lop
    json.dump(ds_cau_hoi, f, ensure_ascii=False, indent=2)

with open("danh_sach_cau_hoi_vat_li_12.json", "r", encoding="utf-8") as f:  # sua lop
...
with open("bai_tap_12.json", "w", encoding="utf-8") as f:  # sua lop
