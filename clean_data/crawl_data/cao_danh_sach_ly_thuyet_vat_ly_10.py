...
list_url = [
    "https://www.vietjack.com/vat-li-10-kn/ly-thuyet-vat-li-lop-10-ket-noi.jsp",
    "https://www.vietjack.com/vat-li-10-ct/ly-thuyet-vat-li-lop-10-chan-troi.jsp",
    "https://www.vietjack.com/vat-li-10-cd/ly-thuyet-vat-li-lop-10-canh-dieu.jsp"
]
...
with open("danh_sach_ly_thuyet_vat_li_10.json", "w", encoding="utf-8") as f:
    json.dump(data, f, ensure_ascii=False, indent=2)

# ---------------------------------------------------------------------------------------------------------------------
json_path = "danh_sach_ly_thuyet_vat_li_10.json"
...
for i, lesson in enumerate(lessons, start=1):
    ...
    invalid_keywords_in_key = ["Lý thuyết Vật Lí 10 Bài"]
...
with open("ly_thuyet_10.json", "w", encoding="utf-8") as f:
