...
# Sidebar content
with st.sidebar:
    st.markdown('<div class="sidebar-header">ChatGPT</div>', unsafe_allow_html=True)
    
    # User info section
    st.markdown('<div class="user-info">Sora</div>', unsafe_allow_html=True)
...
with col2:
    st.text_input("", key="user_input", placeholder="Nhập câu hỏi của bạn...", on_change=process_message)
